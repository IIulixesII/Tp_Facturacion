<div id="weather"
  class="fixed left-2 sm:left-4 md:left-6
         bg-gradient-to-br from-blue-700 to-indigo-900 bg-opacity-70
         rounded-lg p-2 sm:p-3 md:p-4
         w-32 sm:w-36 md:w-48
         text-white shadow-lg font-sans z-50
         text-xs sm:text-sm md:text-sm"
  style="top: 200px; /* móvil */
         /* Luego lo ajustamos con media query inline con JS o CSS */">
...
<style>
  /* CSS para mover más arriba y ajustar tamaño en desktop */
  @media(min-width: 768px) {
    #weather {
      top: 90px !important; /* mucho más arriba en PC */
      opacity: 0.7; /* transparencia general */
      /* Opcional: si querés que todo sea semitransparente, no solo fondo */
    }
  }
</style>
...
<script>
  ...
  async function fetchWeather() {
    try {
      ...
      // Seleccionar icono basado en descripción
      let iconSVG = icons["soleado"]; // default

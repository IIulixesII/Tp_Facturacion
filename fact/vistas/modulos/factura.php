...
<div class="max-w-4xl mx-auto bg-[#2c3e50] p-10 rounded-3xl shadow-xl mt-8 text-white font-roboto">
    ...
    <form action="" method="POST" class="flex flex-col sm:flex-row items-center gap-4 mb-8">
        <input 
            ...
            class="flex-grow p-3 rounded-lg shadow-inner text-gray-900 font-normal placeholder-gray-600 focus:outline-none focus:ring-4 focus:ring-blue-400 transition" 
            required
            autocomplete="off"
        />
        <button 
